...
public class DashboardTodayRecyclerViewAdapter extends RecyclerView.Adapter<DashboardTodayRecyclerViewAdapter.TodayViewHolder> {
    ...
    public DashboardTodayRecyclerViewAdapter(DashboardTodayViewModel viewModel) {
        this.dashboardTodayViewModel = viewModel;
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull TodayViewHolder holder, int position) {
        ...
        MedicineRecordCardViewModel current = dashboardTodayViewModel.getMedicineRecordListLiveData().getValue().get(position);
    ...
    public int getItemCount() {
        return dashboardTodayViewModel.getMedicineRecordListLiveData().getValue().size();
    }
